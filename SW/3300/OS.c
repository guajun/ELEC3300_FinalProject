...
#define DM4310_POS_STEP 0.001
#define HT4310_POS_STEP 20
...
static void keyboardMotor()
{
    ...
    {
        DM4310_insts[0].control.position += DM4310_POS_STEP;
    }
    ...
    {
        DM4310_insts[1].control.position += DM4310_POS_STEP;
    }
    ...
    {
        HT4310_insts[0].control.position += HT4310_POS_STEP;
    }
    ...
    {
        HT4310_insts[1].control.position += HT4310_POS_STEP;
    }
    ...
    {
        GO_M8010_6_insts[0].tarPos += GO_POS_STEP;
    }
    ...
    {
        GO_M8010_6_insts[1].tarPos += GO_POS_STEP;
    }
